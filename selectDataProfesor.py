...
def export_asignatura_to_excel():
    try:
        ...
        if connection.is_connected():
            ...
            cursor.execute("SELECT NIF, nombre, apellido1, apellido2, municipio FROM profesor")
            ...
            df.to_excel("profesores-1.xlsx", index=False, engine='openpyxl')
            print("Los datos se han exportado a 'profesores-1.xlsx' con éxito.")
