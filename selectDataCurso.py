...
def export_curso_to_excel():
    try:
        ...
        if connection.is_connected():
            ...
            cursor.execute("SELECT idCurso, nombreDescriptivo FROM curso")
            ...
            df.to_excel("curso-1.xlsx", index=False, engine='openpyxl')
            print("Los datos se han exportado a 'curso-1.xlsx' con éxito.")
